...
def make_env(env_id, idx, capture_video, run_name, gamma):
    def thunk():
        ...
        # Note: ClipAction and FlattenObservation are removed as they're not needed
...
def main():
    ...
    for iteration in range(1, args.total_timesteps // args.num_steps // args.num_envs + 1):
        # Annealing the rate if instructed to do so.
        if args.anneal_lr:
            frac = 1.0 - (iteration - 1.0) / (args.total_timesteps // args.num_steps // args.num_envs)
    ...
    print(f"Training completed! Agent saved as '{model_path}'")
