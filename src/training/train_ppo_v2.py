...
from src.environments.pricing_env_v2 import PricingEnv  # Use improved environment


@dataclass
class Args:
    exp_name: str = "ppo_pricing_v2"
    seed: int = 1
    torch_deterministic: bool = True
    cuda: bool = True
    
    # Algorithm specific arguments - FASTER TRAINING FOR TESTING
    env_id: str = "PricingEnv"
    total_timesteps: int = 50000  # Reduced for faster testing
...
def main():
    ...
    print(f"🚀 Starting PPO training with improved environment...")
    print(f"📊 Training for {args.total_timesteps} timesteps (~2-3 minutes)")
            ...
            if "final_info" in infos:
                for info in infos["final_info"]:
                    if info is not None:
                        ...
                        print(f"🎯 Episode complete! Return: ${episodic_return:.2f} (Best: ${best_episodic_return:.2f})")
